...
public class Activity2 {
    ...
    public void getUserInfo() {
        ...
        response.then().body("username", equalTo("gauriR"));
        response.then().body("firstName", equalTo("Gauri"));
        response.then().body("lastName", equalTo("Rewatkar"));
        response.then().body("email", equalTo("gauri@ibm.com"));
        response.then().body("password", equalTo("password123"));
        response.then().body("phone", equalTo("9637153545"));
    }
